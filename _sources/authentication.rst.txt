...
or whatever resource that supports AAD MI, or can be done using
Service Principals. Authentication using personal account isn't recommended
and therefore wasn't implemented.
